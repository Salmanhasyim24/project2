...
@section('content')
                            ...
                            <div class="col-lg-12">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="title" class="form-label">Blog For Title</label>
                                        <input type="text" name="title" value="{{ $blog->title }}"
                                            class="form-control" id="title" placeholder="Enter product title">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="blog_category_id" class="form-label">Category Eng</label>
    ...
    <div class="page-content">
        ...
        <hr>
        <div class="card">
            <form method="post" action="{{ route('update.image', $blog->id) }}" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ asset($blog->image) }}" style="width:100px; height:100px">
                    </div>
