                  ...
                  <div class="col-12">
                          ...
                          <nav class="menu__nav">
                              <div class="logo">
                                  <a href="{{ route('home') }}" class="logo__black"><img
                                          src="{{ asset('frontend/assets/img/logo/logo_salman.png') }}"
                                          alt=""></a>
                      ...
                      <div class="mobile__menu">
                          <nav class="menu__box">
                              ...
                              <div class="nav-logo">
                                  <a href="{{ route('home') }}" class="logo__black"><img
                                          src="assets/img/logo/logo_black.png" alt=""></a>
                                  <a href="{{ route('home') }}" class="logo__white"><img
                                          src="assets/img/logo/logo_white.png" alt=""></a>
                              </div>
                              ...
                              <div class="social-links">
                                  ...
                                  <ul class="clearfix">
                                      ...
                                      <li><a href="{{ $allfooter->facebook }}"><span
                                                  class="fab fa-facebook-square"></span></a></li>
                                      <li><a href="#"><span class="fab fa-pinterest-p"></span></a></li>
                                      <li><a href="{{ $allfooter->instagram }}"><span
